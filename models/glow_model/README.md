This code is cloned from https://github.com/y0ast/Glow-PyTorch, full credit for model implementation goes to them.
...
![Histogram Glow - CIFAR10 and SVHN](../../anomaly_methods/plots/seminal_paper_recreations/histogram_glow_cifar_svhn.png)

**To create histogram**:
See [notebook](../../anomaly_methods/Do_deep_generative_models_know_what_they_dont_know.ipynb).
...
* The [first notebook](../../anomaly_methods/Do_deep_generative_models_know_what_they_dont_know.ipynb) reproduces a plot from "Do Deep Generative models know what they don't know?" (see above) and computes the average bpd on the CIFAR-10 and SVHN test sets.
* The [second notebook](../../anomaly_methods/Sample_from_Glow.ipynb) allows you to visualise samples from the model (This works best with a model trained using the `additive` coupling layer).
